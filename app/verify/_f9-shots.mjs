/**
 * F8 evidence screenshots (390×844): every segment of PY.M9.exceptions
 * (autoplay frame stopping at predict gates, then forced final frame) + the typed
 * card before/after grading. Writes PNGs to docs/tasks/python-track/evidence/F9.
 */
import { chromium } from "playwright";

const APP = "http://localhost:4173";
const EV = "/Users/admin/Desktop/CodeApp/docs/tasks/python-track/evidence/F9";
...
await page.evaluate(() => window.__app.openLesson("PY.M9.exceptions"));
await page.waitForFunction(() => window.__viz && window.__viz.ready && window.__lesson.id === "PY.M9.exceptions", { timeout: 15000 });
await sleep(300);
