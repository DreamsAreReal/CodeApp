/**
 * F12 evidence screenshots (390×844): every segment of PY.M12.strings-flow
 * (autoplay frame stopping at predict gates, then forced final frame) + the typed
 * card before/after grading. Writes PNGs to docs/tasks/python-track/evidence/F12.
 */
import { chromium } from "playwright";

const APP = "http://localhost:4173";
const EV = "/Users/admin/Desktop/CodeApp/docs/tasks/python-track/evidence/F12";
...
await page.waitForFunction(() => window.__viz && window.__viz.ready && window.__lesson.id === "PY.M12.strings-flow", { timeout: 15000 });
await sleep(300);
