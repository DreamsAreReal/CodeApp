...
const EXPECT = [
  ...
  { id: "CS.S4.func-action-predicate", segs: 6, ev: "CS-FUNCACT" },
  { id: "CS.S4.events", segs: 6, ev: "CS-EVENTS" },
  { id: "CS.S4.delegate-variance", segs: 6, ev: "CS-DELVAR" },
  { id: "CS.S4.async-event-handlers", segs: 6, ev: "CS-ASYNCEV" },
  ...
  { id: "CS.S3.deferred-execution", segs: 6, ev: "CS-DEFEXEC" },
  { id: "CS.S3.ienumerable-iqueryable", segs: 5, ev: "CS-IENUMIQ" },
  { id: "CS.S3.linq-providers", segs: 5, ev: "CS-LINQPROV" },
  { id: "CS.S3.plinq", segs: 6, ev: "CS-PLINQ" },
  { id: "CS.S3.custom-operators", segs: 5, ev: "CS-CUSTOMOP" },
  { id: "CS.S5.pattern-overview", segs: 5, ev: "CS-PATOVR" },
  { id: "CS.S5.pattern-vocabulary", segs: 5, ev: "CS-PATVOCAB" },
  { id: "CS.S5.switch-expressions", segs: 5, ev: "CS-SWITCHEXP" },
  { id: "CS.S5.is-declaration", segs: 5, ev: "CS-ISDECL" },
  { id: "CS.S5.relational-logical", segs: 5, ev: "CS-RELLOG" },
  { id: "CS.S5.property-positional", segs: 5, ev: "CS-PROPPOS" },
  { id: "CS.S5.list-patterns", segs: 5, ev: "CS-LISTPAT" },
  { id: "CS.S6.reflection-overview", segs: 5, ev: "CS-REFLOVR" },
  { id: "CS.S6.type-metadata", segs: 5, ev: "CS-TYPEMETA" },
  { id: "CS.S6.dynamic-loading", segs: 5, ev: "CS-DYNLOAD" },
  { id: "CS.S6.attributes", segs: 5, ev: "CS-ATTRS" },
  ...
  { id: "CS.S8.threading-objects", segs: 5, ev: "CS-THROBJ" },
  { id: "CS.S8.volatile-memory-model", segs: 5, ev: "CS-VOLATILE" },
  ...
  { id: "SD.D1.data-models", segs: 5, ev: "SD-DATAMODELS" },
  { id: "SD.D1.storage-engines", segs: 5, ev: "SD-STORAGE" },
  { id: "SD.D1.encoding", segs: 5, ev: "SD-ENCODING" },
  { id: "SD.D2.replication-leaders", segs: 5, ev: "SD-REPLLEADERS" },
