/**
 * F8 evidence screenshots (390×844): every segment of PY.M8.object-model
 * (autoplay frame stopping at predict gates, then forced final frame) + the typed
 * card before/after grading. Writes PNGs to docs/tasks/python-track/evidence/F8.
 */
import { chromium } from "playwright";

const APP = "http://localhost:4173";
const EV = "/Users/admin/Desktop/CodeApp/docs/tasks/python-track/evidence/F8";
...
await page.evaluate(() => window.__app.openLesson("PY.M8.object-model"));
await page.waitForFunction(() => window.__viz && window.__viz.ready && window.__lesson.id === "PY.M8.object-model", { timeout: 15000 });
await sleep(300);
