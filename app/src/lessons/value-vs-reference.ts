...
const Z_STACK: Zone = { x: 14, y: 34, w: 138, h: 168, cls: "vz-zone", label: "СТЕК ПОТОКА", labelCls: "vz-zlabel", lx: 83, ly: 24, sub: "value · inline", subCls: "vz-zsub", subY: 47 };
const Z_HEAP: Zone = { x: 188, y: 34, w: 138, h: 168, cls: "vz-zone heap", label: "GC-КУЧА", labelCls: "vz-zlabel heap", lx: 257, ly: 24, sub: "reference · объект", subCls: "vz-zsub heap", subY: 47 };
  ...
  segments: [
    {
      ...
      scenes: [
        { codeLine: 0, caption: '<b>Value</b>-тип: переменная <span class="hl">содержит сам экземпляр</span> — значение 5 лежит прямо в слоте <code>x</code> на стеке.', nodes: [{ id: "x", kind: "slot", x: 83, y: 92, w: 112, h: 40, name: "x", value: "5", accent: true }], edges: [] },
        { codeLine: 1, caption: '<b>Reference</b>-тип: <code>a</code> держит <span class="hl">ссылку</span> на объект на <b>куче</b>, а не сами данные.', nodes: [{ id: "x", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "x", value: "5" }, { id: "a", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "a", accent: true }, { id: "objA", kind: "obj", x: 257, y: 118, w: 118, h: 54, typeTag: "class Point", value: "X=1", accent: true }], edges: [{ id: "r", from: "a", to: "objA", accent: true }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, out: "", caption: '<code>P</code> — <b>struct</b> (value-тип). <code>a</code> содержит собственный экземпляр: X = 1.', nodes: [{ id: "a", kind: "slot", x: 83, y: 96, w: 130, h: 42, name: "a.X", value: "1" }], edges: [] },
        { codeLine: 1, out: "", caption: '<code>var b = a</code> — копируется <span class="hl">значение целиком</span>: <code>b</code> получает независимую копию.', nodes: [{ id: "a", kind: "slot", x: 83, y: 70, w: 130, h: 40, name: "a.X", value: "1" }, { id: "b", kind: "slot", x: 83, y: 140, w: 130, h: 40, name: "b.X", value: "1", accent: true }], edges: [] },
        { codeLine: 2, out: "", caption: '<code>b.X = 9</code> меняет только <span class="hl">копию</span> <code>b</code>; <code>a</code> не трогается.', nodes: [{ id: "a", kind: "slot", x: 83, y: 70, w: 130, h: 40, name: "a.X", value: "1" }, { id: "b", kind: "slot", x: 83, y: 140, w: 130, h: 40, name: "b.X", value: "9", accent: true }], edges: [] },
        { codeLine: 3, out: "1", caption: '<code>a.X</code> читает свой экземпляр → печатает <b>1</b>.', nodes: [{ id: "a", kind: "slot", x: 83, y: 70, w: 130, h: 40, name: "a.X", value: "1", accent: true }, { id: "b", kind: "slot", x: 83, y: 140, w: 130, h: 40, name: "b.X", value: "9" }], edges: [] },
      ],
    ...
    },
    {
      ...
      console: true,
      scenes: [
        { codeLine: 0, out: "", caption: '<code>C</code> — <b>class</b> (reference-тип). <code>a</code> ссылается на объект на куче: X = 1.', nodes: [{ id: "a", kind: "ref", x: 83, y: 84, w: 112, h: 40, name: "a" }, { id: "obj", kind: "obj", x: 257, y: 104, w: 118, h: 54, typeTag: "class C", value: "X=1" }], edges: [{ id: "ra", from: "a", to: "obj" }] },
        { codeLine: 1, out: "", caption: '<code>var b = a</code> — копируется <span class="hl">ссылка</span>: <code>b</code> указывает на ТОТ ЖЕ объект.', nodes: [{ id: "a", kind: "ref", x: 83, y: 74, w: 112, h: 40, name: "a" }, { id: "b", kind: "ref", x: 83, y: 150, w: 112, h: 40, name: "b", accent: true }, { id: "obj", kind: "obj", x: 257, y: 104, w: 118, h: 54, typeTag: "class C", value: "X=1" }], edges: [{ id: "ra", from: "a", to: "obj" }, { id: "rb", from: "b", to: "obj", accent: true }] },
        { codeLine: 2, out: "", caption: '<code>b.X = 9</code> меняет <span class="hl">общий объект</span> — изменение видно и через <code>a</code>.', nodes: [{ id: "a", kind: "ref", x: 83, y: 74, w: 112, h: 40, name: "a" }, { id: "b", kind: "ref", x: 83, y: 150, w: 112, h: 40, name: "b" }, { id: "obj", kind: "obj", x: 257, y: 104, w: 118, h: 54, typeTag: "class C", value: "X=9", accent: true }], edges: [{ id: "ra", from: "a", to: "obj" }, { id: "rb", from: "b", to: "obj" }] },
        { codeLine: 3, out: "9", caption: '<code>a.X</code> читает тот же объект → печатает <b>9</b>.', nodes: [{ id: "a", kind: "ref", x: 83, y: 74, w: 112, h: 40, name: "a", accent: true }, { id: "b", kind: "ref", x: 83, y: 150, w: 112, h: 40, name: "b" }, { id: "obj", kind: "obj", x: 257, y: 104, w: 118, h: 54, typeTag: "class C", value: "X=9", accent: true }], edges: [{ id: "ra", from: "a", to: "obj", accent: true }, { id: "rb", from: "b", to: "obj" }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: '<b>struct</b> (value): <code>var y = x; y.X = 9;</code> — <code>y</code> это копия, <code>x.X</code> остаётся <b>1</b>.', nodes: [{ id: "x", kind: "slot", x: 83, y: 70, w: 128, h: 40, name: "x.X", value: "1", accent: true }, { id: "y", kind: "slot", x: 83, y: 140, w: 128, h: 40, name: "y.X", value: "9" }], edges: [] },
        { codeLine: 1, caption: '<b>class</b> (reference): та же строка — <code>x</code> и <code>y</code> делят объект, <code>x.X</code> становится <b>9</b>.', nodes: [{ id: "x", kind: "ref", x: 83, y: 70, w: 128, h: 40, name: "x", accent: true }, { id: "y", kind: "ref", x: 83, y: 140, w: 128, h: 40, name: "y" }, { id: "obj", kind: "obj", x: 257, y: 108, w: 118, h: 54, typeTag: "class CP", value: "X=9", accent: true }], edges: [{ id: "e1", from: "x", to: "obj", accent: true }, { id: "e2", from: "y", to: "obj", accent: true }] },
      ],
