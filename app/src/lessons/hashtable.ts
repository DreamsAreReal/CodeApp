    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'В bucket 3 уже лежит запись <code>cat</code> (ключ, значение, хеш).', nodes: [
          { id: "b3", kind: "slot", x: 78, y: 100, w: 120, h: 32, name: "b3", value: "→", accent: true },
          { id: "e_cat", kind: "obj", x: 210, y: 100, w: 108, h: 46, typeTag: "entry cat", value: "1" },
        ...
        { codeLine: 1, caption: '<span class="hl">КОЛЛИЗИЯ</span>: <code>hash("fox") % 8 = 3</code> — тот же bucket. .NET <b>связывает</b> новую запись со старой по индексу → цепочка.', nodes: [
          { id: "b3", kind: "slot", x: 78, y: 100, w: 120, h: 32, name: "b3", value: "→", accent: true },
          { id: "e_fox", kind: "obj", x: 178, y: 100, w: 104, h: 46, typeTag: "entry fox", value: "9", accent: true },
          { id: "e_cat", kind: "obj", x: 300, y: 100, w: 104, h: 46, typeTag: "entry cat", value: "1" },
        ...
        { codeLine: 2, caption: 'Lookup <code>d["fox"]</code>: bucket 3 → идём по цепочке и <b>сравниваем ключи</b> comparer\'ом до совпадения.', nodes: [
          { id: "b3", kind: "slot", x: 78, y: 96, w: 120, h: 30, name: "b3", value: "→" },
          { id: "e_fox", kind: "obj", x: 178, y: 96, w: 104, h: 44, typeTag: "entry fox", value: "9", accent: true },
          { id: "e_cat", kind: "obj", x: 300, y: 96, w: 104, h: 44, typeTag: "entry cat", value: "1" },
          { id: "eq", kind: "gate", x: 178, y: 176, w: 150, h: 40, state: "ok", label: 'Equals("fox","fox")', detail: "✓ ключ найден" },
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Bucket 3 держит цепочку <code>cat → fox</code>. Один хеш — но ключи <b>разные</b>, их надо различить.', nodes: [
          { id: "b3", kind: "slot", x: 78, y: 96, w: 120, h: 30, name: "b3", value: "→" },
          { id: "e_cat", kind: "obj", x: 178, y: 96, w: 104, h: 44, typeTag: "entry cat", value: "1" },
          { id: "e_fox", kind: "obj", x: 300, y: 96, w: 104, h: 44, typeTag: "entry fox", value: "9" },
        ...
        { codeLine: 1, caption: 'Шаг 1: сравниваем искомый <code>"fox"</code> с головой цепочки <code>"cat"</code> → <span class="hl">не равны</span>, идём дальше.', nodes: [
          { id: "b3", kind: "slot", x: 78, y: 92, w: 120, h: 30, name: "b3", value: "→" },
          { id: "e_cat", kind: "obj", x: 178, y: 92, w: 104, h: 44, typeTag: "entry cat", value: "1", accent: true },
          { id: "e_fox", kind: "obj", x: 300, y: 92, w: 104, h: 44, typeTag: "entry fox", value: "9" },
          { id: "eq", kind: "gate", x: 178, y: 174, w: 158, h: 40, state: "fail", label: 'Equals("fox","cat")', detail: "✗ мимо — next" },
        ...
        { codeLine: 2, caption: 'Шаг 2: сравниваем с <code>"fox"</code> → <span class="hl">равны</span>. Только теперь возвращаем значение <b>9</b>.', nodes: [
          { id: "b3", kind: "slot", x: 78, y: 92, w: 120, h: 30, name: "b3", value: "→" },
          { id: "e_cat", kind: "obj", x: 178, y: 92, w: 104, h: 44, typeTag: "entry cat", value: "1" },
          { id: "e_fox", kind: "obj", x: 300, y: 92, w: 104, h: 44, typeTag: "entry fox", value: "9", accent: true },
          { id: "eq", kind: "gate", x: 300, y: 174, w: 150, h: 40, state: "ok", label: 'Equals("fox","fox")', detail: "✓ вернуть 9" },
        ], edges: [{ id: "l", from: "b3", to: "e_cat" }, { id: "ch", from: "e_cat", to: "e_fox" }] },
      ],
