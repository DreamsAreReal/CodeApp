  ...
  segments: [
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Таблица — это <b>массив bucket\'ов</b> (здесь size 8). Пусто: все ячейки свободны, ключей нет.', nodes: [
          { id: "b3", kind: "slot", x: 89, y: 92, w: 130, h: 30, name: "b3", value: "—" },
          { id: "b6", kind: "slot", x: 89, y: 150, w: 130, h: 30, name: "b6", value: "—" },
          { id: "kc", kind: "chip", x: 257, y: 92, w: 60, h: 30, value: "cat" },
          { id: "kd", kind: "chip", x: 257, y: 150, w: 60, h: 30, value: "dog" },
        ], edges: [] },
        { codeLine: 1, caption: '<code>d["cat"]=1</code>: считаем <span class="hl">hash("cat") % 8 = 3</span> → идём <b>прямо</b> в bucket 3, без перебора.', nodes: [
          { id: "b3", kind: "slot", x: 89, y: 92, w: 130, h: 30, name: "b3", value: "cat", accent: true },
          { id: "b6", kind: "slot", x: 89, y: 150, w: 130, h: 30, name: "b6", value: "—" },
          { id: "kc", kind: "chip", x: 257, y: 92, w: 60, h: 30, value: "cat", accent: true },
          { id: "kd", kind: "chip", x: 257, y: 150, w: 60, h: 30, value: "dog" },
        ...
        { codeLine: 2, caption: '<code>d["dog"]=2</code>: <span class="hl">hash("dog") % 8 = 6</span> → bucket 6. Разные хеши — разные ячейки, доступ близок к O(1).', nodes: [
          { id: "b3", kind: "slot", x: 89, y: 92, w: 130, h: 30, name: "b3", value: "cat" },
          { id: "b6", kind: "slot", x: 89, y: 150, w: 130, h: 30, name: "b6", value: "dog", accent: true },
          { id: "kc", kind: "chip", x: 257, y: 92, w: 60, h: 30, value: "cat" },
          { id: "kd", kind: "chip", x: 257, y: 150, w: 60, h: 30, value: "dog", accent: true },
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'В bucket 3 уже лежит запись <code>cat</code> (ключ, значение, хеш).', nodes: [
          { id: "b3", kind: "slot", x: 58, y: 100, w: 72, h: 34, name: "b3", value: "→", accent: true },
          { id: "e_cat", kind: "obj", x: 220, y: 100, w: 112, h: 48, typeTag: "entry cat", value: "1" },
        ...
        { codeLine: 1, caption: '<span class="hl">КОЛЛИЗИЯ</span>: <code>hash("fox") % 8 = 3</code> — тот же bucket. .NET <b>связывает</b> новую запись со старой по индексу → цепочка.', nodes: [
          { id: "b3", kind: "slot", x: 54, y: 100, w: 68, h: 34, name: "b3", value: "→", accent: true },
          { id: "e_fox", kind: "obj", x: 156, y: 100, w: 100, h: 48, typeTag: "entry fox", value: "9", accent: true },
          { id: "e_cat", kind: "obj", x: 276, y: 100, w: 100, h: 48, typeTag: "entry cat", value: "1" },
        ...
        { codeLine: 2, caption: 'Lookup <code>d["fox"]</code>: bucket 3 → идём по цепочке и <b>сравниваем ключи</b> comparer\'ом до совпадения.', nodes: [
          { id: "b3", kind: "slot", x: 54, y: 92, w: 68, h: 32, name: "b3", value: "→" },
          { id: "e_fox", kind: "obj", x: 156, y: 92, w: 100, h: 46, typeTag: "entry fox", value: "9", accent: true },
          { id: "e_cat", kind: "obj", x: 276, y: 92, w: 100, h: 46, typeTag: "entry cat", value: "1" },
          { id: "eq", kind: "gate", x: 170, y: 176, w: 190, h: 42, state: "ok", label: 'Equals("fox","fox")', detail: "✓ ключ найден" },
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Bucket 3 держит цепочку <code>cat → fox</code>. Один хеш — но ключи <b>разные</b>, их надо различить.', nodes: [
          { id: "b3", kind: "slot", x: 54, y: 96, w: 68, h: 32, name: "b3", value: "→" },
          { id: "e_cat", kind: "obj", x: 156, y: 96, w: 100, h: 46, typeTag: "entry cat", value: "1" },
          { id: "e_fox", kind: "obj", x: 276, y: 96, w: 100, h: 46, typeTag: "entry fox", value: "9" },
        ...
        { codeLine: 1, caption: 'Шаг 1: сравниваем искомый <code>"fox"</code> с головой цепочки <code>"cat"</code> → <span class="hl">не равны</span>, идём дальше.', nodes: [
          { id: "b3", kind: "slot", x: 54, y: 92, w: 68, h: 32, name: "b3", value: "→" },
          { id: "e_cat", kind: "obj", x: 156, y: 92, w: 100, h: 46, typeTag: "entry cat", value: "1", accent: true },
          { id: "e_fox", kind: "obj", x: 276, y: 92, w: 100, h: 46, typeTag: "entry fox", value: "9" },
          { id: "eq", kind: "gate", x: 150, y: 176, w: 196, h: 42, state: "fail", label: 'Equals("fox","cat")', detail: "✗ мимо — next" },
        ...
        { codeLine: 2, caption: 'Шаг 2: сравниваем с <code>"fox"</code> → <span class="hl">равны</span>. Только теперь возвращаем значение <b>9</b>.', nodes: [
          { id: "b3", kind: "slot", x: 54, y: 92, w: 68, h: 32, name: "b3", value: "→" },
          { id: "e_cat", kind: "obj", x: 156, y: 92, w: 100, h: 46, typeTag: "entry cat", value: "1" },
          { id: "e_fox", kind: "obj", x: 276, y: 92, w: 100, h: 46, typeTag: "entry fox", value: "9", accent: true },
          { id: "eq", kind: "gate", x: 218, y: 176, w: 190, h: 42, state: "ok", label: 'Equals("fox","fox")', detail: "✓ вернуть 9" },
        ], edges: [{ id: "l", from: "b3", to: "e_cat" }, { id: "ch", from: "e_cat", to: "e_fox" }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Хороший хеш <b>раскидывает</b> ключи по bucket\'ам: короткие цепочки, доступ ~O(1).', nodes: [
          { id: "b1", kind: "slot", x: 90, y: 84, w: 130, h: 28, name: "b1", value: "ant" },
          { id: "b3", kind: "slot", x: 90, y: 122, w: 130, h: 28, name: "b3", value: "cat" },
          { id: "b6", kind: "slot", x: 90, y: 160, w: 130, h: 28, name: "b6", value: "dog" },
          { id: "ok", kind: "gate", x: 258, y: 122, w: 130, h: 40, state: "ok", label: "равномерно", detail: "~O(1)" },
        ], edges: [] },
        { codeLine: 1, caption: '<span class="hl">Вырожденный хеш</span> (<code>GetHashCode()=>0</code>): ВСЕ ключи в <b>один</b> bucket 0 → одна длинная цепочка.', nodes: [
          { id: "b0", kind: "slot", x: 52, y: 120, w: 70, h: 32, name: "b0", value: "→", accent: true },
          { id: "c1", kind: "chip", x: 138, y: 120, w: 46, h: 32, value: "ant", accent: true },
          { id: "c2", kind: "chip", x: 196, y: 120, w: 46, h: 32, value: "cat", accent: true },
          { id: "c3", kind: "chip", x: 254, y: 120, w: 46, h: 32, value: "dog", accent: true },
          { id: "c4", kind: "chip", x: 312, y: 120, w: 46, h: 32, value: "fox", accent: true },
        ...
        { codeLine: 2, caption: 'Lookup теперь <span class="wrong">линейно</span> обходит всю цепочку из n элементов → <b>O(n)</b>. Хеш-таблица выродилась в список.', nodes: [
          { id: "b0", kind: "slot", x: 52, y: 108, w: 70, h: 32, name: "b0", value: "→" },
          { id: "c1", kind: "chip", x: 138, y: 108, w: 46, h: 32, value: "ant" },
          { id: "c2", kind: "chip", x: 196, y: 108, w: 46, h: 32, value: "cat" },
          { id: "c3", kind: "chip", x: 254, y: 108, w: 46, h: 32, value: "dog" },
          { id: "c4", kind: "chip", x: 312, y: 108, w: 46, h: 32, value: "fox", accent: true },
          { id: "scan", kind: "gate", x: 196, y: 182, w: 200, h: 40, state: "fail", label: "скан n сравнений", detail: "O(n) — деградация" },
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Массив <b>size 8</b> почти полон: цепочки удлиняются, <span class="hl">фактор загрузки</span> растёт.', nodes: [
          { id: "b3", kind: "slot", x: 90, y: 88, w: 150, h: 30, name: "b3", value: "cat → fox" },
          { id: "b6", kind: "slot", x: 90, y: 130, w: 150, h: 30, name: "b6", value: "dog → ant" },
          { id: "load", kind: "gate", x: 270, y: 110, w: 118, h: 40, state: "fail", label: "load высок", detail: "цепочки ↑" },
        ], edges: [] },
        { codeLine: 1, caption: 'Триггер: .NET <b>реаллоцирует</b> внутренний массив вдвое (8 → <span class="hl">16</span>) — свободных индексов больше.', nodes: [
          { id: "old", kind: "obj", x: 96, y: 110, w: 120, h: 50, typeTag: "старый массив", value: "size 8" },
          { id: "new", kind: "obj", x: 262, y: 110, w: 120, h: 50, typeTag: "новый массив", value: "size 16", accent: true },
        ...
        { codeLine: 2, caption: '<b>Rehash</b>: индекс каждого ключа пересчитывается <code>hash % 16</code> и запись переезжает. Цепочки снова короткие → амортизированно O(1).', nodes: [
          { id: "n3", kind: "slot", x: 88, y: 84, w: 130, h: 28, name: "b3", value: "cat", accent: true },
          { id: "n6", kind: "slot", x: 88, y: 118, w: 130, h: 28, name: "b6", value: "dog" },
          { id: "n11", kind: "slot", x: 88, y: 152, w: 130, h: 28, name: "b11", value: "fox", accent: true },
          { id: "n14", kind: "slot", x: 88, y: 186, w: 130, h: 28, name: "b14", value: "ant" },
          { id: "ok", kind: "gate", x: 258, y: 118, w: 130, h: 40, state: "ok", label: "перераспределено", detail: "hash % 16" },
        ], edges: [] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, out: "", caption: '<code>d["cat"]=1</code>: ключа ещё нет → <b>вставка</b>. Count = 1.', nodes: [
          { id: "bc", kind: "slot", x: 100, y: 96, w: 180, h: 34, name: "cat", value: "1", accent: true },
          { id: "cnt", kind: "chip", x: 264, y: 96, w: 92, h: 34, value: "Count 1" },
        ], edges: [] },
        { codeLine: 1, out: "", caption: '<code>d["dog"]=2</code>: <span class="hl">другой</span> ключ → новая запись. Count = 2.', nodes: [
          { id: "bc", kind: "slot", x: 100, y: 84, w: 180, h: 32, name: "cat", value: "1" },
          { id: "bd", kind: "slot", x: 100, y: 126, w: 180, h: 32, name: "dog", value: "2", accent: true },
          { id: "cnt", kind: "chip", x: 264, y: 105, w: 92, h: 34, value: "Count 2" },
        ], edges: [] },
        { codeLine: 2, out: "", caption: '<code>d["cat"]=3</code>: ключ <b>уже есть</b> → индексатор <span class="hl">перезаписывает</span> значение той же записи. Новой строки нет.', nodes: [
          { id: "bc", kind: "slot", x: 100, y: 84, w: 180, h: 32, name: "cat", value: "1 → 3", accent: true },
          { id: "bd", kind: "slot", x: 100, y: 126, w: 180, h: 32, name: "dog", value: "2" },
          { id: "cnt", kind: "chip", x: 264, y: 105, w: 92, h: 34, value: "Count 2" },
        ], edges: [] },
        { codeLine: 3, out: "2", caption: '<code>WriteLine(d.Count)</code> → <b>2</b>: два <span class="hl">уникальных</span> ключа, третья вставка лишь обновила <code>cat</code>.', nodes: [
          { id: "bc", kind: "slot", x: 100, y: 84, w: 180, h: 32, name: "cat", value: "3" },
          { id: "bd", kind: "slot", x: 100, y: 126, w: 180, h: 32, name: "dog", value: "2" },
          { id: "cnt", kind: "chip", x: 264, y: 105, w: 92, h: 34, value: "Count 2", accent: true },
        ], edges: [] },
      ],
