  ...
  segments: [
    ...
    },
    {
      ...
      scenes: [
        ...
        { codeLine: 3, caption: '<code>Make</code> вернулся, стек-кадр ушёл — но объект <span class="hl">жив</span>, пока жив делегат: «isn\'t garbage collected until the delegate… becomes eligible».', nodes: [{ id: "ret", kind: "ref", x: 83, y: 108, w: 118, h: 40, name: "делегат", accent: true }, { id: "dc", kind: "obj", x: 257, y: 100, w: 130, h: 54, typeTag: "DisplayClass", value: "seed=42", accent: true }], edges: [{ id: "e", from: "ret", to: "dc", accent: true }] },
      ],
