...
const Z_STACK: Zone = { x: 14, y: 34, w: 138, h: 168, cls: "vz-zone", label: "СТЕК ПОТОКА", labelCls: "vz-zlabel", lx: 83, ly: 24, sub: "локальные · слоты", subCls: "vz-zsub", subY: 47 };
const Z_HEAP: Zone = { x: 188, y: 34, w: 138, h: 168, cls: "vz-zone heap", label: "GC-КУЧА", labelCls: "vz-zlabel heap", lx: 257, ly: 24, sub: "display class", subCls: "vz-zsub heap", subY: 47 };
  ...
  segments: [
    {
      ...
      scenes: [
        { codeLine: 1, out: "", caption: 'Лямбда ссылается на <b>внешнюю переменную</b> <code>n</code> — «Lambdas can refer to <span class="hl">outer variables</span>». Это захват переменной, а не копия значения.', nodes: [{ id: "n", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "n", value: "1" }, { id: "add", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "add", accent: true }, { id: "cap", kind: "chip", x: 257, y: 108, w: 84, h: 26, value: "→ n" }], edges: [{ id: "e", from: "add", to: "cap", accent: true }] },
        { codeLine: 2, out: "", caption: '<code>n = 100</code> меняет <span class="hl">ту же ячейку</span>, на которую смотрит лямбда — захвачена переменная, не снимок.', nodes: [{ id: "n", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "n", value: "100", accent: true }, { id: "add", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "add" }, { id: "cap", kind: "chip", x: 257, y: 108, w: 84, h: 26, value: "→ n" }], edges: [{ id: "e", from: "add", to: "cap", accent: true }] },
        { codeLine: 3, out: "105", caption: 'При вызове лямбда читает <span class="hl">текущее</span> <code>n = 100</code> → <code>5 + 100 = 105</code>. Значение берётся в момент <b>вызова</b>, не создания.', nodes: [{ id: "n", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "n", value: "100" }, { id: "add", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "add", accent: true }, { id: "cap", kind: "chip", x: 257, y: 108, w: 84, h: 26, value: "→ 100", accent: true }], edges: [{ id: "e", from: "add", to: "cap", accent: true }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 1, ilLine: 0, caption: 'Есть захват → компилятор генерит <b>display-класс</b> (<code>&lt;&gt;c__DisplayClass</code>) и создаёт его экземпляр на <span class="hl">куче</span>.', nodes: [{ id: "dc", kind: "obj", x: 257, y: 108, w: 130, h: 54, typeTag: "DisplayClass", value: "", accent: true }], edges: [] },
        { codeLine: 1, ilLine: 1, caption: 'Локальная <code>n</code> <span class="hl">поднимается</span> (hoisting) и становится <b>полем</b> этого объекта — она больше не живёт просто на стеке.', nodes: [{ id: "dc", kind: "obj", x: 257, y: 96, w: 130, h: 60, typeTag: "DisplayClass", value: "", accent: true }, { id: "nf", kind: "slot", x: 257, y: 104, w: 104, h: 30, name: "n", value: "1" }], edges: [] },
        { codeLine: 1, ilLine: 2, caption: 'Тело лямбды — <b>метод</b> display-класса (<code>&lt;&gt;b__0</code>); делегат <code>add</code> держит ссылку на объект и на этот метод.', nodes: [{ id: "add", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "add", accent: true }, { id: "dc", kind: "obj", x: 257, y: 96, w: 130, h: 60, typeTag: "DisplayClass", value: "b__0()" }, { id: "nf", kind: "slot", x: 257, y: 104, w: 104, h: 30, name: "n", value: "1" }], edges: [{ id: "e", from: "add", to: "dc", accent: true }] },
      ],
    ...
    },
    {
      ...
      console: true,
      scenes: [
        { codeLine: 1, out: "", caption: 'Обе лямбды захватывают <b>ту же</b> <code>x</code> — компилятор кладёт их в <span class="hl">один</span> display-класс, <code>x</code> = общее поле.', nodes: [{ id: "inc", kind: "ref", x: 83, y: 74, w: 112, h: 40, name: "inc" }, { id: "get", kind: "ref", x: 83, y: 148, w: 112, h: 40, name: "get" }, { id: "dc", kind: "obj", x: 257, y: 100, w: 130, h: 54, typeTag: "shared x", value: "1", accent: true }], edges: [{ id: "e1", from: "inc", to: "dc" }, { id: "e2", from: "get", to: "dc" }] },
        { codeLine: 3, out: "", caption: '<code>inc()</code> дважды меняет <span class="hl">общую ячейку</span> <code>x</code> → 3. Изменение видно всем, кто захватил <code>x</code>.', nodes: [{ id: "inc", kind: "ref", x: 83, y: 74, w: 112, h: 40, name: "inc", accent: true }, { id: "get", kind: "ref", x: 83, y: 148, w: 112, h: 40, name: "get" }, { id: "dc", kind: "obj", x: 257, y: 100, w: 130, h: 54, typeTag: "shared x", value: "3", accent: true }], edges: [{ id: "e1", from: "inc", to: "dc", accent: true }, { id: "e2", from: "get", to: "dc" }] },
        { codeLine: 3, out: "3", caption: '<code>get()</code> читает ту же ячейку → печатает <b>3</b>. Разные лямбды — <span class="hl">одно</span> состояние.', nodes: [{ id: "inc", kind: "ref", x: 83, y: 74, w: 112, h: 40, name: "inc" }, { id: "get", kind: "ref", x: 83, y: 148, w: 112, h: 40, name: "get", accent: true }, { id: "dc", kind: "obj", x: 257, y: 100, w: 130, h: 54, typeTag: "shared x", value: "3", accent: true }], edges: [{ id: "e1", from: "inc", to: "dc" }, { id: "e2", from: "get", to: "dc", accent: true }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 1, caption: '<code>seed</code> — локальная в <code>Make</code>. Обычно после выхода из метода её слот на стеке исчезает.', nodes: [{ id: "seed", kind: "slot", x: 83, y: 108, w: 118, h: 40, name: "seed", value: "42", accent: true }], edges: [] },
        { codeLine: 2, caption: 'Лямбда <span class="hl">захватывает</span> <code>seed</code> → она уже поле display-класса на <b>куче</b>, а не стековый слот.', nodes: [{ id: "seed", kind: "slot", x: 83, y: 108, w: 118, h: 40, name: "seed", value: "42", state: "" }, { id: "dc", kind: "obj", x: 257, y: 100, w: 130, h: 54, typeTag: "DisplayClass", value: "seed=42", accent: true }], edges: [] },
        { codeLine: 3, caption: '<code>Make</code> вернулся, стек-кадр ушёл — но объект <span class="hl">жив</span>, пока жив делегат: «isn\'t garbage collected until the delegate… becomes eligible».', nodes: [{ id: "ret", kind: "chip", x: 83, y: 108, w: 118, h: 40, value: "делегат", accent: true }, { id: "dc", kind: "obj", x: 257, y: 100, w: 130, h: 54, typeTag: "DisplayClass", value: "seed=42", accent: true }], edges: [{ id: "e", from: "ret", to: "dc", accent: true }] },
      ],
    ...
    },
    {
      ...
      viewBox: "0 0 340 214",
      zones: [
        { x: 14, y: 34, w: 150, h: 168, cls: "vz-zone", label: "for · одна i", labelCls: "vz-zlabel sm", lx: 89, ly: 24, sub: "общая ячейка", subCls: "vz-zsub", subY: 47 },
        { x: 176, y: 34, w: 150, h: 168, cls: "vz-zone good", label: "foreach · своя n", labelCls: "vz-zlabel good sm", lx: 251, ly: 24, sub: "по ячейке/итер.", subCls: "vz-zsub good", subY: 47 },
      ],
      ...
      scenes: [
        { codeLine: 1, out: "", caption: '<b>for</b>: единственная переменная <code>i</code> на весь цикл. Все три лямбды захватывают <span class="hl">одну и ту же</span> ячейку.', nodes: [{ id: "l0", kind: "ref", x: 89, y: 76, w: 118, h: 26, name: "λ0" }, { id: "l1", kind: "ref", x: 89, y: 112, w: 118, h: 26, name: "λ1" }, { id: "l2", kind: "ref", x: 89, y: 148, w: 118, h: 26, name: "λ2" }, { id: "i", kind: "chip", x: 251, y: 112, w: 60, h: 30, value: "i", accent: true }], edges: [{ id: "e0", from: "l0", to: "i" }, { id: "e1", from: "l1", to: "i" }, { id: "e2", from: "l2", to: "i", accent: true }] },
        { codeLine: 2, out: "333", caption: 'После цикла <code>i == 3</code>. Каждая лямбда читает <span class="hl">общую</span> ячейку → печатает <b>3</b> трижды: <code>333</code>. (Реальный прогон.)', nodes: [{ id: "l0", kind: "ref", x: 89, y: 76, w: 118, h: 26, name: "λ0" }, { id: "l1", kind: "ref", x: 89, y: 112, w: 118, h: 26, name: "λ1" }, { id: "l2", kind: "ref", x: 89, y: 148, w: 118, h: 26, name: "λ2" }, { id: "i", kind: "chip", x: 251, y: 112, w: 60, h: 30, value: "3", accent: true }], edges: [{ id: "e0", from: "l0", to: "i" }, { id: "e1", from: "l1", to: "i" }, { id: "e2", from: "l2", to: "i" }] },
        { codeLine: 2, out: "333", caption: '<b>foreach</b> (C# 5+) даёт <span class="hl">свежую</span> переменную на итерацию → <code>012</code>. Спека: «because each iteration has its own variable v… earlier versions of C# declared v outside».', nodes: [{ id: "n0", kind: "chip", x: 251, y: 72, w: 60, h: 28, value: "n=0", good: true }, { id: "n1", kind: "chip", x: 251, y: 110, w: 60, h: 28, value: "n=1", good: true }, { id: "n2", kind: "chip", x: 251, y: 148, w: 60, h: 28, value: "n=2", good: true, accent: true }, { id: "gate", kind: "gate", x: 89, y: 112, w: 130, h: 44, state: "ok", label: "foreach → 012", detail: "своя ячейка/итер." }], edges: [] },
      ],
