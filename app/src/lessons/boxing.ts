  ...
  segments: [
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Значение <b>123</b> лежит прямо в слоте <b>i</b> на <b>стеке</b> — value-тип живёт inline.', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "i", value: "123" }], edges: [] },
        { codeLine: 1, caption: 'Действие 1 — <span class="hl">аллокация</span>: CLR создаёт пустую обёртку <code>System.Object</code> на управляемой <b>куче</b>.', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "i", value: "123" }, { id: "obj", kind: "obj", x: 257, y: 120, w: 112, h: 54, typeTag: "[int]", value: "", accent: true }, { id: "cp", kind: "chip", x: 83, y: 78, w: 30, h: 26, value: "123" }], edges: [] },
        { codeLine: 1, caption: 'Действие 2 — <span class="hl">копия</span>: значение переносится со стека <b>внутрь</b> нового объекта (у value-типа семантика значения).', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "i", value: "123" }, { id: "obj", kind: "obj", x: 257, y: 120, w: 112, h: 54, typeTag: "[int]", value: "", accent: true }, { id: "cp", kind: "chip", x: 257, y: 120, w: 30, h: 26, value: "123" }], edges: [] },
        { codeLine: 1, caption: 'Действие 3 — на стеке появляется <b>ссылка</b> <code>o</code> на объект. <code>o</code> хранит ссылку, а не копию значения.', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "i", value: "123" }, { id: "o", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "o", accent: true }, { id: "obj", kind: "obj", x: 257, y: 120, w: 112, h: 54, typeTag: "[int]", value: "123", accent: true }], edges: [{ id: "r", from: "o", to: "obj", accent: true }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 1, out: "", caption: 'После упаковки <b>o</b> ссылается на <span class="hl">независимую копию</span> 123 на куче.', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "i", value: "123" }, { id: "o", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "o" }, { id: "obj", kind: "obj", x: 257, y: 120, w: 112, h: 54, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
        { codeLine: 2, out: "", caption: '<b>i = 456</b> меняет только слот на <b>стеке</b>; упакованная копия на куче <span class="hl">не трогается</span>.', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "i", value: "456", accent: true }, { id: "o", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "o" }, { id: "obj", kind: "obj", x: 257, y: 120, w: 112, h: 54, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
        { codeLine: 3, out: "123", caption: '<b>WriteLine(o)</b> читает объект на куче → печатает <b>123</b>, а не 456.', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "i", value: "456" }, { id: "o", kind: "ref", x: 83, y: 140, w: 112, h: 40, name: "o" }, { id: "obj", kind: "obj", x: 257, y: 120, w: 112, h: 54, typeTag: "[int]", value: "123", accent: true }], edges: [{ id: "r", from: "o", to: "obj", accent: true }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: '<b>o</b> ссылается на boxed <code>int</code> на куче. Дальше распаковываем его тремя способами.', nodes: [{ id: "o", kind: "ref", x: 83, y: 80, w: 112, h: 40, name: "o" }, { id: "obj", kind: "obj", x: 257, y: 100, w: 112, h: 54, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
        { codeLine: 1, caption: '<b>(int)o</b>: гейт проверяет тип — <span class="hl">int == int ✓</span> — и копирует значение наружу в <code>n</code>.', nodes: [{ id: "n", kind: "slot", x: 83, y: 80, w: 112, h: 40, name: "n", value: "123", accent: true }, { id: "gate", kind: "gate", x: 170, y: 158, w: 120, h: 44, state: "ok", label: "проверка типа", detail: "int == int  ✓" }, { id: "obj", kind: "obj", x: 257, y: 100, w: 112, h: 54, typeTag: "[int]", value: "123" }, { id: "cp", kind: "chip", x: 257, y: 100, w: 30, h: 26, value: "123" }], edges: [] },
        { codeLine: 2, caption: '<b>(short)o</b>: запрошен <code>short</code>, а в коробке <code>int</code> → <span class="hl">гейт закрыт</span>. Не тихое сужение, а исключение.', nodes: [{ id: "o", kind: "ref", x: 83, y: 80, w: 112, h: 40, name: "o" }, { id: "gate", kind: "gate", x: 170, y: 158, w: 150, h: 44, state: "fail", label: "short ≠ int", detail: "InvalidCastException" }, { id: "obj", kind: "obj", x: 257, y: 100, w: 112, h: 54, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
        { codeLine: 3, caption: 'Распаковка <b>null</b>: разыменовывать нечего → <span class="hl">гейт закрыт</span>.', nodes: [{ id: "o", kind: "ref", x: 83, y: 80, w: 112, h: 40, name: "o", value: "null" }, { id: "gate", kind: "gate", x: 170, y: 158, w: 162, h: 44, state: "fail", label: "unbox null", detail: "NullReferenceException" }], edges: [] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, ilLine: 0, caption: 'Компилятор кладёт значение на стек вычислений (<code>ldc.i4.s 123</code>).', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "eval", value: "123" }], edges: [] },
        { codeLine: 0, ilLine: 1, caption: 'Опкод <span class="hl">box int32</span> создаёт новый объект и копирует в него данные value-типа.', nodes: [{ id: "i", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "eval", value: "123" }, { id: "o", kind: "ref", x: 83, y: 138, w: 112, h: 40, name: "o", accent: true }, { id: "obj", kind: "obj", x: 257, y: 118, w: 112, h: 54, typeTag: "[int]", value: "123", accent: true }], edges: [{ id: "r", from: "o", to: "obj", accent: true }] },
        { codeLine: 1, ilLine: 4, caption: 'Каст <code>(int)o</code> эмитит <span class="hl">unbox.any int32</span> — извлекает значение из коробки в <code>n</code>.', nodes: [{ id: "n", kind: "slot", x: 83, y: 78, w: 112, h: 40, name: "n", value: "123", accent: true }, { id: "o", kind: "ref", x: 83, y: 138, w: 112, h: 40, name: "o" }, { id: "obj", kind: "obj", x: 257, y: 118, w: 112, h: 54, typeTag: "[int]", value: "123" }, { id: "cp", kind: "chip", x: 257, y: 118, w: 30, h: 26, value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Случай 1 — <b>локальная value-переменная</b>: живёт в стеке своего потока (и это GC-root).', nodes: [{ id: "x", kind: "slot", x: 83, y: 72, w: 112, h: 40, name: "x", value: "7", accent: true }], edges: [] },
        { codeLine: 1, caption: 'Случай 2 — <b>value-поле</b> объекта: лежит <span class="hl">inline внутри</span> содержащего объекта на куче, отдельно не аллоцируется.', nodes: [{ id: "x", kind: "slot", x: 83, y: 72, w: 112, h: 40, name: "x", value: "7" }, { id: "objN", kind: "obj", x: 257, y: 96, w: 118, h: 62, typeTag: "class N", value: "", accent: true }, { id: "F", kind: "slot", x: 257, y: 104, w: 92, h: 30, name: "F", value: "7" }], edges: [] },
        { codeLine: 2, caption: 'Случай 3 — <b>boxed</b>-значение: отдельный объект на <span class="hl">общей куче</span> (одна на процесс, видна всем потокам).', nodes: [{ id: "x", kind: "slot", x: 83, y: 72, w: 112, h: 40, name: "x", value: "7" }, { id: "objN", kind: "obj", x: 257, y: 96, w: 118, h: 62, typeTag: "class N", value: "" }, { id: "F", kind: "slot", x: 257, y: 104, w: 92, h: 30, name: "F", value: "7" }, { id: "box", kind: "obj", x: 257, y: 176, w: 112, h: 44, typeTag: "[int] boxed", value: "7", accent: true }], edges: [] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 1, caption: 'Каждая итерация боксит <code>k</code> — это <span class="hl">новая аллокация</span>. Новые объекты идут в поколение 0.', nodes: [{ id: "b0", kind: "obj", x: 64, y: 96, w: 52, h: 40, typeTag: "[int]", value: "0", accent: true }], edges: [] },
        { codeLine: 1, caption: 'Боксы <b>накапливаются</b> в gen 0 — «youngest … short-lived objects». Сборка тут случается чаще всего.', nodes: [{ id: "b0", kind: "obj", x: 64, y: 96, w: 52, h: 40, typeTag: "[int]", value: "0" }, { id: "b1", kind: "obj", x: 128, y: 96, w: 52, h: 40, typeTag: "[int]", value: "1" }, { id: "b2", kind: "obj", x: 192, y: 96, w: 52, h: 40, typeTag: "[int]", value: "2", accent: true }, { id: "b3", kind: "obj", x: 256, y: 96, w: 52, h: 40, typeTag: "[int]", value: "3", accent: true }], edges: [] },
        { codeLine: 1, caption: 'Gen 0 заполнилась → срабатывает <span class="hl">gen 0 collection</span>: сборщик освобождает место под новый объект.', nodes: [{ id: "gc", kind: "gate", x: 170, y: 104, w: 180, h: 46, state: "ok", label: "gen 0 полна →", detail: "GC · collect gen 0" }], edges: [] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: '<code>List&lt;object&gt;.Add(1..3)</code>: каждый <code>int</code> <span class="hl">упакован</span> → N объектов на куче.', nodes: [{ id: "o1", kind: "obj", x: 251, y: 80, w: 96, h: 34, typeTag: "[int]", value: "1", accent: true }, { id: "o2", kind: "obj", x: 251, y: 122, w: 96, h: 34, typeTag: "[int]", value: "2", accent: true }, { id: "o3", kind: "obj", x: 251, y: 164, w: 96, h: 34, typeTag: "[int]", value: "3", accent: true }], edges: [] },
        { codeLine: 1, caption: '<code>List&lt;int&gt;</code>: элементы хранятся <span class="hl">inline</span>, <b>0 боксов</b> — обобщения снимают упаковку по построению.', nodes: [{ id: "c1", kind: "slot", x: 89, y: 80, w: 118, h: 34, name: "[0]", value: "1" }, { id: "c2", kind: "slot", x: 89, y: 122, w: 118, h: 34, name: "[1]", value: "2" }, { id: "c3", kind: "slot", x: 89, y: 164, w: 118, h: 34, name: "[2]", value: "3" }], edges: [] },
        { codeLine: 2, caption: '<b>Скрытый boxing</b>: <code>IComparable c = p</code> над <code>struct p</code> молча упаковывает его — интерфейс это ссылочный тип.', nodes: [{ id: "p", kind: "slot", x: 89, y: 110, w: 118, h: 38, name: "p", value: "struct" }, { id: "hb", kind: "obj", x: 251, y: 110, w: 100, h: 48, typeTag: "boxed p", value: "⇢", accent: true }], edges: [{ id: "e", from: "p", to: "hb", accent: true }] },
      ],
