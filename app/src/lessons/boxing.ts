...
// s3 (unboxing gate) needs a WIDE bottom band because the type-check gate carries a
// long detail line (e.g. "NullReferenceException") that cannot fit a 138u column.
// Stack/heap sit on top (shorter), the gate spans the full width below them.
const Z_STACK_TOP: Zone = { id: "stack", x: 14, y: 34, w: 138, h: 124, cls: "vz-zone", label: "СТЕК ПОТОКА", labelCls: "vz-zlabel", lx: 83, ly: 24, sub: "~1 МБ · Windows", subCls: "vz-zsub", subY: 47 };
const Z_HEAP_TOP: Zone = { id: "heap", x: 188, y: 34, w: 138, h: 124, cls: "vz-zone heap", label: "GC-КУЧА", labelCls: "vz-zlabel heap", lx: 257, ly: 24, sub: "общая · процесс", subCls: "vz-zsub heap", subY: 47 };
const Z_UNBOX_GATE: Zone = { id: "gate", x: 14, y: 166, w: 312, h: 80, cls: "vz-zone", label: "РАСПАКОВКА · ГЕЙТ ТИПА", labelCls: "vz-zlabel sm", lx: 170, ly: 161 };
const UNBOX_ZONES: Zone[] = [Z_STACK_TOP, Z_HEAP_TOP, Z_UNBOX_GATE];
...
export const boxing: LessonData = {
  ...
  sources: [
    ...
    { id: "ms-thread-ctor", kind: "doc", org: "Microsoft Learn", title: "Thread(ThreadStart, Int32) — maxStackSize", url: "https://learn.microsoft.com/en-us/dotnet/api/system.threading.thread.-ctor", date: "2025-07-01", archived: "https://web.archive.org/web/20250824233223/https://learn.microsoft.com/en-us/dotnet/api/system.threading.thread.-ctor?view=net-9.0" },
    { id: "ms-il-box", kind: "doc", org: "Microsoft Learn", title: "OpCodes.Box (box, IL 0x8C)", url: "https://learn.microsoft.com/en-us/dotnet/api/system.reflection.emit.opcodes.box", date: "2025-07-01", archived: "https://web.archive.org/web/20240910153809/https://learn.microsoft.com/en-us/dotnet/api/system.reflection.emit.opcodes.box?view=net-8.0" },
    { id: "ms-il-unbox", kind: "doc", org: "Microsoft Learn", title: "OpCodes.Unbox_Any (unbox.any, IL 0xA5)", url: "https://learn.microsoft.com/en-us/dotnet/api/system.reflection.emit.opcodes.unbox_any", date: "2025-07-01", archived: "https://web.archive.org/web/20251228093229/https://learn.microsoft.com/en-us/dotnet/api/system.reflection.emit.opcodes.unbox_any?view=net-10.0" },
  ],
  ...
  segments: [
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Значение <b>123</b> лежит прямо в слоте <b>i</b> на <b>стеке</b> — value-тип живёт inline.', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "i", value: "123" }], edges: [] },
        { codeLine: 1, caption: 'Действие 1 — <span class="hl">аллокация</span>: CLR создаёт пустую обёртку <code>System.Object</code> на управляемой <b>куче</b>.', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "i", value: "123" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "", accent: true }, { id: "cp", kind: "chip", at: { zone: "stack", row: 1 }, value: "123" }], edges: [] },
        { codeLine: 1, caption: 'Действие 2 — <span class="hl">копия</span>: значение переносится со стека <b>внутрь</b> нового объекта (у value-типа семантика значения).', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "i", value: "123" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "", accent: true }, { id: "cp", kind: "chip", at: { zone: "heap", row: 1 }, value: "123" }], edges: [] },
        { codeLine: 1, caption: 'Действие 3 — на стеке появляется <b>ссылка</b> <code>o</code> на объект. <code>o</code> хранит ссылку, а не копию значения.', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "i", value: "123" }, { id: "o", kind: "ref", at: { zone: "stack", row: 1 }, name: "o", accent: true }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123", accent: true }], edges: [{ id: "r", from: "o", to: "obj", accent: true }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 1, out: "", caption: 'После упаковки <b>o</b> ссылается на <span class="hl">независимую копию</span> 123 на куче.', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "i", value: "123" }, { id: "o", kind: "ref", at: { zone: "stack", row: 1 }, name: "o" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
        { codeLine: 2, out: "", caption: '<b>i = 456</b> меняет только слот на <b>стеке</b>; упакованная копия на куче <span class="hl">не трогается</span>.', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "i", value: "456", accent: true }, { id: "o", kind: "ref", at: { zone: "stack", row: 1 }, name: "o" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
        { codeLine: 3, out: "123", caption: '<b>WriteLine(o)</b> читает объект на куче → печатает <b>123</b>, а не 456.', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "i", value: "456" }, { id: "o", kind: "ref", at: { zone: "stack", row: 1 }, name: "o" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123", accent: true }], edges: [{ id: "r", from: "o", to: "obj", accent: true }] },
      ],
    ...
    },
    {
      ...
      viewBox: "0 0 340 250", zones: UNBOX_ZONES,
      code: ["object o = 123;", "int   n = (int)o;", "short s = (short)o;", "int   b = (int)null;"],
      scenes: [
        { codeLine: 0, caption: '<b>o</b> ссылается на boxed <code>int</code> на куче. Дальше распаковываем его тремя способами.', nodes: [{ id: "o", kind: "ref", at: { zone: "stack", row: 0 }, name: "o" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
        { codeLine: 1, caption: '<b>(int)o</b>: гейт проверяет тип — <span class="hl">int == int ✓</span> — и копирует значение наружу в <code>n</code>.', nodes: [{ id: "n", kind: "slot", at: { zone: "stack", row: 0 }, name: "n", value: "123", accent: true }, { id: "gate", kind: "gate", at: { zone: "gate", row: 0 }, state: "ok", label: "проверка типа", detail: "int == int  ✓" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123" }, { id: "cp", kind: "chip", at: { zone: "heap", row: 1 }, value: "123" }], edges: [] },
        { codeLine: 2, caption: '<b>(short)o</b>: запрошен <code>short</code>, а в коробке <code>int</code> → <span class="hl">гейт закрыт</span>. Не тихое сужение, а исключение.', nodes: [{ id: "o", kind: "ref", at: { zone: "stack", row: 0 }, name: "o" }, { id: "gate", kind: "gate", at: { zone: "gate", row: 0 }, state: "fail", label: "short ≠ int", detail: "InvalidCastException" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
        { codeLine: 3, caption: 'Распаковка <b>null</b>: разыменовывать нечего → <span class="hl">гейт закрыт</span>.', nodes: [{ id: "o", kind: "ref", at: { zone: "stack", row: 0 }, name: "o", value: "null" }, { id: "none", kind: "chip", at: { zone: "heap", row: 0 }, value: "нет объекта" }, { id: "gate", kind: "gate", at: { zone: "gate", row: 0 }, state: "fail", label: "unbox null", detail: "NullReferenceException" }], edges: [] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, ilLine: 0, caption: 'Компилятор кладёт значение на стек вычислений (<code>ldc.i4.s 123</code>).', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "eval", value: "123" }], edges: [] },
        { codeLine: 0, ilLine: 1, caption: 'Опкод <span class="hl">box int32</span> создаёт новый объект и копирует в него данные value-типа.', nodes: [{ id: "i", kind: "slot", at: { zone: "stack", row: 0 }, name: "eval", value: "123" }, { id: "o", kind: "ref", at: { zone: "stack", row: 1 }, name: "o", accent: true }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123", accent: true }], edges: [{ id: "r", from: "o", to: "obj", accent: true }] },
        { codeLine: 1, ilLine: 4, caption: 'Каст <code>(int)o</code> эмитит <span class="hl">unbox.any int32</span> — извлекает значение из коробки в <code>n</code>.', nodes: [{ id: "n", kind: "slot", at: { zone: "stack", row: 0 }, name: "n", value: "123", accent: true }, { id: "o", kind: "ref", at: { zone: "stack", row: 1 }, name: "o" }, { id: "obj", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "[int]", value: "123" }], edges: [{ id: "r", from: "o", to: "obj" }] },
      ],
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, caption: 'Случай 1 — <b>локальная value-переменная</b>: живёт в стеке своего потока (и это GC-root).', nodes: [{ id: "x", kind: "slot", at: { zone: "stack", row: 0 }, name: "x", value: "7", accent: true }], edges: [] },
        { codeLine: 1, caption: 'Случай 2 — <b>value-поле</b> объекта: лежит <span class="hl">inline внутри</span> содержащего объекта на куче, отдельно не аллоцируется.', nodes: [{ id: "x", kind: "slot", at: { zone: "stack", row: 0 }, name: "x", value: "7" }, { id: "objN", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "class N", value: "", accent: true }, { id: "F", kind: "slot", at: { in: "objN" }, name: "F", value: "7" }], edges: [] },
        { codeLine: 2, caption: 'Случай 3 — <b>boxed</b>-значение: отдельный объект на <span class="hl">общей куче</span> (одна на процесс, видна всем потокам).', nodes: [{ id: "x", kind: "slot", at: { zone: "stack", row: 0 }, name: "x", value: "7" }, { id: "objN", kind: "obj", at: { zone: "heap", row: 0 }, typeTag: "class N", value: "" }, { id: "F", kind: "slot", at: { in: "objN" }, name: "F", value: "7" }, { id: "box", kind: "obj", at: { zone: "heap", row: 1 }, typeTag: "[int] boxed", value: "7", accent: true }], edges: [] },
      ],
    ...
    },
    {
      ...
      viewBox: "0 0 340 196",
      zones: [{ id: "gen0", x: 14, y: 34, w: 312, h: 150, cls: "vz-zone heap", label: "GC-КУЧА · GEN 0", labelCls: "vz-zlabel heap", lx: 170, ly: 24, sub: "новые объекты · короткоживущие", subCls: "vz-zsub heap", subY: 47 }],
      code: ["for (int k = 0; k < N; k++)", "    object box = k;"],
      scenes: [
        { codeLine: 1, caption: 'Каждая итерация боксит <code>k</code> — это <span class="hl">новая аллокация</span>. Новые объекты идут в поколение 0.', nodes: [{ id: "b0", kind: "obj", at: { zone: "gen0", row: 0, col: 0 }, typeTag: "[int]", value: "0", accent: true }], edges: [] },
        { codeLine: 1, caption: 'Боксы <b>накапливаются</b> в gen 0 — «youngest … short-lived objects». Сборка тут случается чаще всего.', nodes: [{ id: "b0", kind: "obj", at: { zone: "gen0", row: 0, col: 0 }, typeTag: "[int]", value: "0" }, { id: "b1", kind: "obj", at: { zone: "gen0", row: 0, col: 1 }, typeTag: "[int]", value: "1" }, { id: "b2", kind: "obj", at: { zone: "gen0", row: 0, col: 2 }, typeTag: "[int]", value: "2", accent: true }, { id: "b3", kind: "obj", at: { zone: "gen0", row: 0, col: 3 }, typeTag: "[int]", value: "3", accent: true }], edges: [] },
        { codeLine: 1, caption: 'Gen 0 заполнилась → срабатывает <span class="hl">gen 0 collection</span>: сборщик освобождает место под новый объект.', nodes: [{ id: "gc", kind: "gate", at: { zone: "gen0", row: 0 }, state: "ok", label: "gen 0 полна →", detail: "GC · collect gen 0" }], edges: [] },
      ],
    ...
    },
    {
      ...
      viewBox: "0 0 340 272",
      zones: [
        { id: "stackInline", x: 14, y: 34, w: 150, h: 232, cls: "vz-zone good", label: "СТЕК · INLINE", labelCls: "vz-zlabel good sm", lx: 89, ly: 24, sub: "0 боксов", subCls: "vz-zsub good", subY: 47 },
        { id: "heapN", x: 176, y: 34, w: 150, h: 232, cls: "vz-zone heap", label: "GC-КУЧА", labelCls: "vz-zlabel heap sm", lx: 251, ly: 24, sub: "N аллокаций", subCls: "vz-zsub heap", subY: 47 },
      ],
      code: ["List<object> a = [];   // boxes", "List<int>    b = [];   // no box", "IComparable  c = p;    // hidden"],
      scenes: [
        { codeLine: 0, caption: '<code>List&lt;object&gt;.Add(1..3)</code>: каждый <code>int</code> <span class="hl">упакован</span> → N объектов на куче.', nodes: [{ id: "o1", kind: "obj", at: { zone: "heapN", row: 0 }, typeTag: "[int]", value: "1", accent: true }, { id: "o2", kind: "obj", at: { zone: "heapN", row: 1 }, typeTag: "[int]", value: "2", accent: true }, { id: "o3", kind: "obj", at: { zone: "heapN", row: 2 }, typeTag: "[int]", value: "3", accent: true }], edges: [] },
        { codeLine: 1, caption: '<code>List&lt;int&gt;</code>: элементы хранятся <span class="hl">inline</span>, <b>0 боксов</b> — обобщения снимают упаковку по построению.', nodes: [{ id: "c1", kind: "slot", at: { zone: "stackInline", row: 0 }, name: "[0]", value: "1" }, { id: "c2", kind: "slot", at: { zone: "stackInline", row: 1 }, name: "[1]", value: "2" }, { id: "c3", kind: "slot", at: { zone: "stackInline", row: 2 }, name: "[2]", value: "3" }], edges: [] },
        { codeLine: 2, caption: '<b>Скрытый boxing</b>: <code>IComparable c = p</code> над <code>struct p</code> молча упаковывает его — интерфейс это ссылочный тип.', nodes: [{ id: "p", kind: "slot", at: { zone: "stackInline", row: 0 }, name: "p", value: "struct" }, { id: "o1", kind: "obj", at: { zone: "heapN", row: 0 }, typeTag: "[int]", value: "1" }, { id: "hb", kind: "obj", at: { zone: "heapN", row: 1 }, typeTag: "boxed p", value: "⇢", accent: true }], edges: [{ id: "e", from: "p", to: "hb", accent: true }] },
      ],
