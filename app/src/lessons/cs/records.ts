...
export const records: LessonData = {
  ...
  edgeCases: [
    ...
    { text: "Объявлять override <code>Object.Equals</code> и <code>==</code>/<code>!=</code> вручную — <b>ОШИБКА компиляции</b>; а <code>Equals(R?)</code>, <code>GetHashCode</code> и <code>EqualityContract</code> объявлять <span class=\"hl\">можно</span> («You can declare this property explicitly»). Свой <code>Clone</code>/член с именем <code>Clone</code> — запрещён.", source: "ms-record" },
