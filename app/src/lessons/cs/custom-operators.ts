...
export const customOperators: LessonData = {
  ...
  edgeCases: [
    { text: "LINQ-операторы — это и есть extension-методы: «The most common extension members are the <span class=\"hl\">LINQ standard query operators</span> that add query functionality to the existing <code>System.Collections.IEnumerable</code> and <code>System.Collections.Generic.IEnumerable&lt;T&gt;</code> types».", source: "ms-ext" },
