  ...
  segments: [
    ...
    },
    {
      ...
      scenes: [
        ...
        { codeLine: 3, out: "", caption: 'Дерево «you examine, modify, or execute» <span class="ru-tr">«который можно исследовать, изменять или исполнять»</span> — <span class="hl">инспекция</span> вместо исполнения. Библиотека читает форму запроса, не запуская вашу лямбду в .NET.', nodes: [{ id: "sql", kind: "gate", at: { zone: "sql", row: 0 }, state: "ok", label: "инспекция дерева", detail: "→ другой язык", accent: true }], edges: [] },
      ],
