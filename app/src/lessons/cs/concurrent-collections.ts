...
export const concurrentCollections: LessonData = {
  ...
  cards: [
    ...
    },
    {
      ...
      noText: 'Снимок «does not reflect any updates after GetEnumerator». 4-й элемент добавлен позже — энумератор его не видит (3), живая очередь — 4. Вывод: <b>snapshot-count=3 live-count=4</b>.',
