  ...
  segments: [
    {
      ...
      scenes: [
        ...
        { codeLine: 1, out: "", caption: 'CLR обеспечивает <b>загрузку сборок</b>, где определены эти типы, в контекст загрузки (в .NET — <code>AssemblyLoadContext</code>; во времена книги — домен приложений).', nodes: [{ id: "m3", kind: "obj", at: { zone: "jitm", row: 0 }, typeTag: "JIT M3", value: "нашёл типы" }, { id: "asm", kind: "gate", at: { zone: "jitm", row: 1 }, state: "ok", label: "сборки", detail: "загружены", accent: true }], edges: [] },
