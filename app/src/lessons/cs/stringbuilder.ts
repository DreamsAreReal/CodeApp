  ...
  segments: [
    ...
    },
    {
      ...
      scenes: [
        ...
        { codeLine: 2, out: "True\nabc", caption: 'Панель: <span class="hl">True / abc</span> (реальный прогон) — <code>same</code> и <code>sb</code> это <b>один</b> объект (Append вернул <code>this</code>), значение <code>"abc"</code>.', nodes: [{ id: "g", kind: "gate", at: { zone: "buf", row: 0 }, state: "ok", label: "ReferenceEquals(sb, same)", detail: "True · один объект", accent: true }], edges: [] },
      ],
