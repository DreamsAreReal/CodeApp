...
const Z_LIST: Zone = { id: "list", x: 14, y: 34, w: 138, h: 168, cls: "vz-zone", label: "List<int>", labelCls: "vz-zlabel sm", lx: 83, ly: 24, sub: "обёртка", subCls: "vz-zsub", subY: 47 };
const Z_ARR: Zone = { id: "arr", x: 188, y: 34, w: 138, h: 168, cls: "vz-zone good", label: "int[] под капотом", labelCls: "vz-zlabel good sm", lx: 257, ly: 24, sub: "непрерывная память", subCls: "vz-zsub good", subY: 47 };
