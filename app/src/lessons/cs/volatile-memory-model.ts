...
export const volatileMemoryModel: LessonData = {
  ...
  segments: [
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 0, out: "", caption: 'По умолчанию — <code>lock</code>/<code>Monitor</code>: «the C# lock statement… and the Monitor class provide the <span class="hl">easiest and least error-prone way</span> of synchronizing access to data».', nodes: [{ id: "l", kind: "gate", at: { zone: "lockdef", row: 0 }, state: "ok", label: "lock", detail: "дефолт · проще", accent: true }], edges: [] },
