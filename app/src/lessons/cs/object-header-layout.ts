...
export const objectHeaderLayout: LessonData = {
  ...
  segments: [
    ...
    },
    {
      ...
      scenes: [
        { codeLine: 1, out: "", caption: '<b>Индекс блока синхронизации</b> — служит для блокировок/идентичности: индекс в массиве блоков синхронизации CLR (по умолчанию −1 — блок синхронизации не выделен).', nodes: [{ id: "sync", kind: "obj", at: { zone: "hdr", row: 0 }, typeTag: "sync block index", value: "для lock/identity", accent: true }], edges: [] },
