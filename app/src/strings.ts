...
export const S = {
  ...
  // Re-built C# track (ADR-0004): «C#/.NET вглубь» — sectioned track (S1 type system,
  // S2 async, S7 memory/GC, …), its own home group. The legacy «Фундамент C#» group and its
  // 6 T1/T2 lessons were retired in the F2 migration.
